...
urlpatterns = [
    ...
    path('pointages/prestations/', views.statistiques_prestations, name='statistiques_prestations'),
    path('pointages/prestations/export-csv/', views.exporter_prestations_csv, name='prestations_export_csv'),
    ...
    path('pointages/utilisateur/<uuid:utilisateur_id>/prestations/export-csv/', views.exporter_prestations_csv, name='prestations_export_utilisateur_csv'),
