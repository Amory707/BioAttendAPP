...
class ScheduleRequestForm(forms.ModelForm):
    ...
    def __init__(self, *args, actor=None, is_admin=False, **kwargs):
        ...
        self.fields['category'].choices = self.ALLOWED_CATEGORY_CHOICES
    ...
    def clean_category(self):
        ...
        allowed_values = {value for value, _ in self.ALLOWED_CATEGORY_CHOICES}
        if category not in allowed_values:
            raise forms.ValidationError("Cette raison ne peut pas être encodée manuellement.")
        return category
